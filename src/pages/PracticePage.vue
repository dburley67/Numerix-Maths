    ...
    <div v-else class="exercises-page">
      ...
      <div class="ex-filter-bar">
        <div class="ex-filter-group">
          <span class="ex-filter-label"
            ><i class="fa-solid fa-layer-group"></i> Topic</span
          >
        ...
        <div class="ex-filter-group">
          <span class="ex-filter-label"
            ><i class="fa-solid fa-signal"></i> Difficulty</span
          >
          <div class="ex-filter-pills">
            <button
              ...
              class="ex-pill"
              :class="[
                'ex-pill-diff-' + d.value,
                { 'ex-pill-active': activeDiffFilter === d.value },
              ]"
      ...
      <div class="ex-grid">
        ...
        >
          ...
          <div class="ex-card-body">
            ...
            <div class="ex-tags">
              <span v-for="tag in set.tags" :key="tag" class="ex-tag">{{
                tag
              }}</span>
            </div>
      ...
      <div v-if="filteredSets.length === 0" class="ex-empty">
        ...
        <button class="ex-clear-btn" @click="clearFilters">
          Clear filters
        </button>
      </div>
...
const exerciseSets2 = ref([
  {
    ...
    description:
      "Round numbers to 1, 2 and 3 decimal places using the standard rounding rule.",
  ...
  },
  {
    ...
    description:
      "Round numbers to a given number of significant figures, including decimals and large numbers.",
  ...
  },
  {
    ...
    description:
      "Multi-step rounding where each step affects the next — the tricky type!",
  ...
  },
  {
    ...
    description:
      "List all factors of a given number using the pair method, working from 1 upwards.",
  ...
  },
  {
    ...
    description:
      "Find the HCF of two numbers by listing and comparing their factor sets.",
  ...
  },
  {
    ...
    description:
      "Apply the HCF method to larger numbers where the factor lists are longer.",
  ...
  },
  {
    ...
    description:
      "Convert between standard form and ordinary numbers using positive powers of 10.",
  ...
  },
  {
    ...
    description:
      "Multiply and divide numbers written in standard form, expressing results correctly.",
...
const filteredSets = computed(() => {
  return exerciseSets2.value.filter((s) => {
    const topicOk =
      activeTopicFilter.value === "all" || s.topic === activeTopicFilter.value;
    const diffOk =
      activeDiffFilter.value === "all" ||
      s.difficulty === activeDiffFilter.value;
    return topicOk && diffOk;
  });
});

const totalQuestions = computed(() =>
  exerciseSets2.value.reduce((a, s) => a + s.questions, 0),
);
...
.ex-pill-diff-foundation:hover {
  border-color: #2563eb;
  color: #2563eb;
}
.ex-pill-diff-higher:hover {
  border-color: #9333ea;
  color: #9333ea;
}
.ex-pill-diff-challenge:hover {
  border-color: #dc2626;
  color: #dc2626;
}
...
body.dark .icon-decimals {
  background: #172554;
  color: #60a5fa;
}
body.dark .icon-factors {
  background: #2e1065;
  color: #c4b5fd;
}
body.dark .icon-standard {
  background: #022c22;
  color: #5eead4;
}
