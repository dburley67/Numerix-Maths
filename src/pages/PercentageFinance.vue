    ...
    <div class="lesson-page">
      ...
      <div class="lesson-hero">
        ...
        <p class="lesson-hero-sub">
          Learn how to calculate percentages, discounts and simple interest in
        ...
        <div class="section-body">
          ...
          <div class="method-wrap">
            ...
            <div class="method-steps">
              <div class="method-row method-row-yes">20 × 50 ÷ 100 = 10</div>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="quiz-opts">
                <button
                  ...
                  :class="{
                    ...
                    'opt-neutral':
                      q.selected && opt !== q.answer && opt !== q.selected,
                  }"
      ...
      <div class="lesson-summary" ref="sec6" :class="{ visible: sec6Visible }">
        ...
        <ul class="summary-list">
          ...
          <li>
            <i class="fa-solid fa-check"></i> Interest grows money over time
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="video-sidebar-card">
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            ...
            <span class="video-topic">What are Percentages?</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/1Yft5uHL82M"
          ...
          <p class="lesson-video-desc">
            A simple introduction to percentages, including what “out of 100” means and how percentages are used in everyday maths.
          </p>
        </div>
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            ...
            <span class="video-topic">Finding Percentages of Amounts</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
          ...
          <p class="lesson-video-desc">
            Walks through how to calculate percentages of numbers step by step, including common values like 10%, 25%, and 50%.
          </p>
        </div>
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            ...
            <span class="video-topic">Discounts, Interest and Real-Life Finance</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/5qxX222sLtE"
          ...
          <p class="lesson-video-desc">
            Shows how percentages are used in shopping, savings, discounts, and simple interest questions.
          </p>
        </div>
      </div>
    </aside>
...
const progress = computed(() => {
  return (
    (Object.values(visible).filter((v) => v.value).length / sections.length) *
    100
  );
});
