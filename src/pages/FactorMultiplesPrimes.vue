    ...
    <div class="lesson-page">
      ...
      <div class="lesson-hero">
        ...
        <p class="lesson-hero-sub">
          Learn how to find factors of numbers and identify the Highest Common
          Factor (HCF).
        </p>
        <div class="lesson-hero-chips">
          ...
          >
          <span class="hero-chip"
            ><i class="fa-regular fa-clock"></i> ~25 min</span
          >
          <span class="hero-chip hero-chip-indigo"
      ...
      <div class="lesson-section" ref="sec1" :class="{ visible: sec1Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            A <strong>factor</strong> of a number is any whole number that
            divides into it <em>exactly</em>, leaving no remainder. Every number
            has at least two factors: <strong>1</strong> and
            <strong>itself</strong>.
          </p>

          <div class="factor-pairs-wrap">
            <div class="fp-title">
              Factor pairs of <span class="num-highlight">12</span>
            </div>
            <div class="fp-grid">
            ...
            <div class="fp-result">
              ...
              <span class="fp-all">
                <span
                  ...
                  >{{ f
                  }}<span v-if="i < factors12.length - 1">,&nbsp;</span></span
                >
              </span>
            </div>
          </div>
          ...
          <div class="callout callout-indigo" style="margin-top: 16px">
            ...
            <div>
              <strong>Tip:</strong> Work from 1 upwards. When you reach a number
              you already have, you've found them all — no need to keep going!
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="lesson-section" ref="sec2" :class="{ visible: sec2Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            To find all factors systematically, test each number starting from
            1. Ask:
            <em>"Does this divide into my number with no remainder?"</em>
          </p>

          <div class="method-wrap">
            <div class="method-number">
              Finding factors of <span class="num-highlight">12</span>
            </div>
            <div class="method-steps">
              ...
              >
                <div class="mr-check">
                  <i
                    :class="
                      step.divides ? 'fa-solid fa-check' : 'fa-solid fa-xmark'
                    "
                  ></i>
                </div>
                <div class="mr-eq">
                  12 ÷ {{ step.divisor }} =
                  {{ step.divides ? 12 / step.divisor : "?" }}
                  <span v-if="!step.divides" class="mr-remainder"
                    >(remainder {{ 12 % step.divisor }})</span
                  >
                </div>
                <div class="mr-tag" v-if="step.divides">
                  ...
                  <span
                    class="factor-tag"
                    v-if="step.divisor !== 12 / step.divisor"
                    >+{{ 12 / step.divisor }}</span
                  >
                </div>
                <div class="mr-stop-tag" v-if="step.stop">
                  <i class="fa-solid fa-flag-checkered"></i> Already found
                  these!
                </div>
              </div>
            </div>
      ...
      <div class="lesson-section" ref="sec3" :class="{ visible: sec3Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            The <strong>Highest Common Factor (HCF)</strong> is the largest
            number that divides exactly into two (or more) numbers. Find all
            factors of each number, then pick the biggest one they share.
          </p>
            ...
            <div class="whiteboard">
              ...
              >
                ...
                <text
                  x="211"
                  y="96"
                  class="svg-factors-center svg-factor-circled"
                  text-anchor="middle"
                >
                  3
                </text>
                ...
                <path
                  d="M 211 104 C 208 130, 215 145, 210 165 C 205 185, 198 195, 200 210"
                  fill="none"
                  stroke="#2563eb"
                  stroke-width="6"
                ...
                <ellipse
                  ...
                  class="oval-draw-2"
                />
                <text x="200" y="241" class="svg-big-num" text-anchor="middle">
                  3
                </text>

                <path
                  d="M 198 256 C 192 278, 185 290, 182 310 C 178 328, 170 335, 168 350"
                  fill="none"
                  stroke="#2563eb"
                  stroke-width="6"
                  stroke-linecap="round"
            ...
            <div class="steps-panel">
                ...
                <div class="step-text">
                  ...
                  <span class="step-ex">
                    <span v-for="(f, i) in factors12" :key="f">
                      <span :class="{ 'hl-blue': commonFactors.includes(f) }">{{
                        f
                      }}</span
                      ><span v-if="i < factors12.length - 1">, </span>
                    </span>
                  </span>
                </div>
              </div>
                ...
                <div class="step-text">
                  ...
                  <span class="step-ex">
                    <span v-for="(f, i) in factors15" :key="f">
                      ...
                      ><span v-if="i < factors15.length - 1">, </span>
                    </span>
                  </span>
                </div>
              </div>
                ...
                <div class="step-text">
                  ...
                  <span class="step-ex">
                    ...
                    <span v-for="(f, i) in commonFactors" :key="f">
                      <span class="hl-blue">{{ f }}</span
                      ><span v-if="i < commonFactors.length - 1">, </span>
                    </span>
                  </span>
                </div>
              </div>
              <div class="step-item">
                ...
                <div class="step-text">
                  ...
                  <span class="step-ex">
                    HCF of 12 and 15 =
                    <strong class="hl-blue">{{ hcf }}</strong>
                  </span>
                </div>
              </div>
              <div class="step-result step-result-blue">
                ...
                <span class="step-result-val"
                  >HCF(12, 15) = <strong>{{ hcf }}</strong></span
                >
              </div>
            </div>
          </div>
      ...
      <div class="lesson-section" ref="sec4" :class="{ visible: sec4Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            Enter any two numbers and see their factors and HCF calculated step
            by step.
          </p>
          ...
          <div class="explorer-wrap">
            ...
            <div v-if="explorerValid" class="explorer-result">
              ...
              <div class="exp-row">
                ...
                <div class="exp-factor-list">
                  <span
                    v-for="f in explorerCommon"
                    :key="f"
                    class="exp-chip exp-chip-common"
                    >{{ f }}</span
                  >
                </div>
              </div>
      ...
      <div class="lesson-summary" ref="sec6" :class="{ visible: sec6Visible }">
        ...
        <ul class="summary-list">
          <li>
            <i class="fa-solid fa-check"></i> A <strong>factor</strong> divides
            into a number with no remainder
          </li>
          <li>
            <i class="fa-solid fa-check"></i> Find factors by testing from 1
            upwards in pairs
          </li>
          <li>
            <i class="fa-solid fa-check"></i> Stop when you reach a number
            already recorded
          </li>
          <li>
            <i class="fa-solid fa-check"></i> The <strong>HCF</strong> is the
            largest factor shared by both numbers
          </li>
        </ul>
      ...
      <div class="video-sidebar-card">
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            <span class="video-tag">Video 1</span>
            <span class="video-topic">Finding factors of a number</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/vcn2ruTOwFo"
              title="Finding factors of a number"
              allow="
                accelerometer;
                autoplay;
                clipboard-write;
          ...
          <p class="lesson-video-desc">
            A quick walkthrough of how to list factors and spot factor pairs.
          </p>
        </div>

        <div class="lesson-video-card">
          <div class="lesson-video-top">
            <span class="video-tag">Video 2</span>
            <span class="video-topic">Highest Common Factor (HCF)</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/1F9CTS3aH9c"
          ...
          <p class="lesson-video-desc">
            Useful for understanding how to compare factors and find the highest
            one in common.
          </p>
        </div>
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            <span class="video-tag">Video 3</span>
            <span class="video-topic">HCF practice questions</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/qk97o4bXBiM"
              title="HCF practice questions"
              allow="
                accelerometer;
                autoplay;
                clipboard-write;
          ...
          <p class="lesson-video-desc">
            Extra worked examples and practice questions with step-by-step
            solutions.
          </p>
        </div>
      </div>
...
const explorerValid = computed(
  () =>
    numA.value >= 1 &&
    numB.value >= 1 &&
    Number.isInteger(numA.value) &&
    Number.isInteger(numB.value) &&
    numA.value <= 200 &&
    numB.value <= 200,
);
...
const explorerCommon = computed(() =>
  explorerFactorsA.value.filter((f) => explorerFactorsB.value.includes(f)),
);
const explorerHCF = computed(() =>
  explorerCommon.value.length ? Math.max(...explorerCommon.value) : 1,
);

function calcExplorer() {}
...
const quizQuestions = ref([
  {
    ...
    selected: null,
    explanation:
      "Factors of 8: 1,2,4,8. Factors of 12: 1,2,3,4,6,12. Highest common = 4.",
  },
  {
    a: 6,
    b: 9,
    ...
    selected: null,
    explanation:
      "Factors of 6: 1,2,3,6. Factors of 9: 1,3,9. Highest common = 3.",
  },
  {
    a: 20,
    b: 30,
    ...
    selected: null,
    explanation:
      "Factors of 20: 1,2,4,5,10,20. Factors of 30: 1,2,3,5,6,10,15,30. Highest common = 10.",
  },
  {
    a: 14,
    b: 21,
    ...
    selected: null,
    explanation:
      "Factors of 14: 1,2,7,14. Factors of 21: 1,3,7,21. Highest common = 7.",
  },
]);
...
body.dark .method-row-yes {
  background: #052e16;
  border-color: #16a34a;
  color: #4ade80;
}

body.dark .method-row-no {
  background: #450a0a;
  border-color: #dc2626;
  color: #f87171;
}

body.dark .method-row-stop {
  background: #422006;
  border-color: #ca8a04;
  color: #fbbf24;
}
...
.oval-draw-3 {
  ...
  animation: draw-stroke 0.6s ease forwards 2s;
}
