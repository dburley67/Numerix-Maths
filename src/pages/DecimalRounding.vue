<template>
  <div class="lesson-page">
    ...
    <div class="lesson-hero">
      ...
      <h1 class="lesson-hero-title">Decimals &amp; Rounding</h1>
      <p class="lesson-hero-sub">
        Learn how to round decimal numbers to any required degree of accuracy.
      </p>
    ...
    <!-- ── SECTION 1: What is rounding? ── -->
    <div class="lesson-section" ref="sec1" :class="{ visible: sec1Visible }">
      <div class="section-header">
        <div class="section-num">1</div>
        <h2 class="section-title">What is Rounding?</h2>
      </div>
      <div class="section-body">
        <p class="lesson-text">
          Rounding is the process of simplifying a number by reducing its digits while keeping
          it close to the original value. We look at the <strong>last digit we want to keep</strong>
          and decide whether to round <span class="text-up">up</span> or <span class="text-down">down</span>
          based on the digit that follows it.
        </p>

        <!-- Range rule card -->
        <div class="rule-cards">
          <div class="rule-card rule-card-down">
            <div class="rule-range">0 – 4</div>
            <div class="rule-arrow">
              <i class="fa-solid fa-arrow-down"></i>
            </div>
            <div class="rule-label">Round <strong>Down</strong></div>
            <div class="rule-desc">Keep the digit the same</div>
          </div>
          <div class="rule-card rule-card-up">
            <div class="rule-range">5 – 9</div>
            <div class="rule-arrow">
              <i class="fa-solid fa-arrow-up"></i>
            </div>
            <div class="rule-label">Round <strong>Up</strong></div>
            <div class="rule-desc">Increase the digit by 1</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-section" ref="sec2" :class="{ visible: sec2Visible }">
      <div class="section-header">
        ...
        <h2 class="section-title">Worked Example: 4.5 → 5</h2>
      </div>
      <div class="section-body">
        <p class="lesson-text">
          Let's round <strong>4.5</strong> to the nearest whole number.
          We look at the decimal digit <strong class="text-red">5</strong> — it falls in the
          <strong>5–9</strong> range, so we round <span class="text-up">up</span>.
        </p>
        ...
        <div class="diagram-wrap">
          <div class="whiteboard">
            <svg class="diagram-svg" viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- 4.5 number -->
              <text x="80" y="110" class="svg-num-black">4.</text>
              <text x="138" y="110" class="svg-num-red">5</text>

              <!-- Red oval around the 5 -->
              <ellipse cx="152" cy="97" rx="26" ry="32"
                fill="none" stroke="#dc2626" stroke-width="3.5"
                class="svg-draw oval-draw" />

              <!-- Red arrow from oval to "5-9" label -->
              <line x1="176" y1="105" x2="258" y2="148"
                stroke="#dc2626" stroke-width="3"
                stroke-linecap="round"
                class="svg-draw line-draw" />

              <!-- 5-9 label -->
              <text x="265" y="158" class="svg-label-black svg-fade" style="animation-delay:0.9s">5–9</text>

              <!-- Green down-arrow (check / tick style) -->
              <!-- Left arm of check -->
              <line x1="100" y1="148" x2="124" y2="178"
                stroke="#16a34a" stroke-width="5"
                stroke-linecap="round"
                class="svg-draw line-draw-green" />
              <!-- Right arm of check -->
              <line x1="124" y1="178" x2="148" y2="138"
                stroke="#16a34a" stroke-width="5"
                stroke-linecap="round"
                class="svg-draw line-draw-green2" />

              <!-- Arrow head on right arm -->
              <polygon points="148,138 138,150 160,148"
                fill="#16a34a"
                class="svg-fade" style="animation-delay:1.1s" />
            ...
            <div class="diagram-legend">
              <span class="legend-item legend-red">
                <span class="legend-dot"></span> Digit to check
              </span>
              <span class="legend-item legend-green">
                <span class="legend-dot"></span> Result
              </span>
            </div>
          </div>
          ...
          <div class="steps-panel">
            <div class="step-item">
              ...
              <div class="step-text">
                <strong>Identify</strong> the digit after the one you're rounding to.<br />
                <span class="step-ex">4.<span class="hl-red">5</span> — the decimal digit is <strong>5</strong></span>
              </div>
            </div>
            <div class="step-item">
              <div class="step-dot step-dot-2">2</div>
              <div class="step-text">
                <strong>Check the range</strong> — does it fall in 0–4 or 5–9?<br />
                <span class="step-ex"><span class="hl-red">5</span> falls in the <strong>5–9</strong> range</span>
              </div>
            </div>
            <div class="step-item">
              <div class="step-dot step-dot-3">3</div>
              <div class="step-text">
                <strong>Round up</strong> — increase the digit to the left by 1.<br />
                <span class="step-ex"><span class="hl-black">4</span> becomes <span class="hl-green">5</span></span>
              </div>
            </div>
            <div class="step-result">
              <span class="step-result-label">Answer:</span>
              <span class="step-result-val">4.5 → <strong>5</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- ── SECTION 3: Chain Rounding ── -->
    <div class="lesson-section" ref="sec3" :class="{ visible: sec3Visible }">
      <div class="section-header">
        <div class="section-num">3</div>
        <h2 class="section-title">Chain Rounding: 4.45 → 5</h2>
      </div>
      <div class="section-body">
        <p class="lesson-text">
          Sometimes you need to perform <strong>multiple rounds</strong> to reach your target precision.
          If the first decimal place is a 4, it normally rounds down — but if the <em>next</em> digit
          causes it to round up to 5 first, that changes everything.
        </p>

        <!-- Chain diagram -->
        <div class="chain-wrap">
          <div class="chain-number">
            <span class="cn-black">4.</span><span class="cn-black">4</span><span class="cn-red">5</span>
          </div>
          ...
          <div class="chain-steps">
            ...
            <div class="chain-step">
              ...
              <div class="chain-step-body">
                <div class="chain-focus">
                  Look at <span class="hl-red">5</span> (2nd decimal)
                </div>
                <div class="chain-rule">
                  <i class="fa-solid fa-arrow-up text-up"></i>
                  5 is in <strong>5–9</strong> → round <strong>up</strong>
                </div>
                <div class="chain-result-line">
                  4.4<span class="hl-red">5</span>
                  <i class="fa-solid fa-arrow-right chain-arrow"></i>
                  4.<span class="hl-green">5</span>
                </div>
              </div>
            </div>
            ...
            <div class="chain-step">
              ...
              <div class="chain-step-body">
                <div class="chain-focus">
                  Now look at <span class="hl-red">5</span> (1st decimal)
                </div>
                <div class="chain-rule">
                  <i class="fa-solid fa-arrow-up text-up"></i>
                  5 is in <strong>5–9</strong> → round <strong>up</strong>
                ...
                <div class="chain-result-line">
                  4.<span class="hl-red">5</span>
                  <i class="fa-solid fa-arrow-right chain-arrow"></i>
                  <span class="hl-green">5</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="chain-final">
            ...
            <span class="chain-final-eq">4.45 → 4.5 → <strong>5</strong></span>
          </div>
        </div>
        ...
        <div class="callout callout-blue">
          ...
          <div>
            <strong>Key Insight:</strong> Always round from the <em>rightmost</em> digit first and
            work your way left. A digit that looks like it rounds down may round up once its
            neighbour is resolved.
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lesson-section" ref="sec4" :class="{ visible: sec4Visible }">
      ...
      <div class="section-body">
        ...
        <div class="quiz-grid">
          ...
          >
            <div class="quiz-q">Round <strong>{{ q.number }}</strong> to the nearest whole number</div>
            <div class="quiz-opts">
              <button
    ...
    <!-- ── Summary ── -->
    <div class="lesson-summary" ref="sec5" :class="{ visible: sec5Visible }">
      <h3 class="summary-title"><i class="fa-solid fa-circle-check"></i> Lesson Summary</h3>
      <ul class="summary-list">
        <li><i class="fa-solid fa-check"></i> Look at the digit <em>after</em> the one you're keeping</li>
        <li><i class="fa-solid fa-check"></i> <strong>0–4</strong> → round down (keep the digit the same)</li>
        <li><i class="fa-solid fa-check"></i> <strong>5–9</strong> → round up (add 1 to the digit)</li>
        <li><i class="fa-solid fa-check"></i> For chain rounding, always work <em>right to left</em></li>
      </ul>
      <div class="summary-actions">
        <button class="btn-next">
          Next Lesson: Factors, Multiples &amp; Primes
...
const progress = computed(() => {
  const flags = [sec1Visible.value, sec2Visible.value, sec3Visible.value, sec4Visible.value, sec5Visible.value];
...
const quizQuestions = ref([
  {
    ...
    answer: 4,
    selected: null,
    explanation: "The decimal digit is 7 (in 5–9), so round up: 3.7 → 4."
  },
  {
    number: "8.3",
    options: [7, 8, 9],
    answer: 8,
    selected: null,
    explanation: "The decimal digit is 3 (in 0–4), so round down: 8.3 → 8."
  },
  {
    number: "2.45",
    options: [2, 3, 4],
    answer: 2,
    selected: null,
    explanation: "5 rounds the 4 up → 2.5, but 5 in 1st decimal rounds 2 up → wait, 2.45 → 2.5 → 3. Correct answer is 2… actually 3."
  },
  {
    number: "6.85",
    options: [6, 7, 8],
...
quizQuestions.value[2].answer = 2;
quizQuestions.value[2].options = [2, 3, 4];
quizQuestions.value[2].explanation = "2.45: the 5 rounds the 4 up → 2.5, then 5 rounds the 2 up → 3.";
quizQuestions.value[2].answer = 3;
