    ...
    <div class="lesson-page">
      <div class="lesson-hero">
        ...
        <p class="lesson-hero-sub">
          Master the math of chance. Learn how to calculate likelihood, use the
          probability scale, and predict outcomes.
        </p>
        <div class="lesson-hero-chips">
          ...
          <span class="hero-chip hero-chip-indigo"
            ><i class="fa-solid fa-signal"></i> Core Skills</span
          >
        </div>
      </div>
      ...
      <div class="lesson-section" ref="sec1" :class="{ visible: sec1Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            Probability is a value between <strong>0</strong> and
            <strong>1</strong>. It tells us how likely an event is to happen.
          </p>
          ...
          <div class="callout callout-indigo">
            ...
            <div>
              Pro-tip: Probability can be written as a
              <strong>fraction</strong>, a <strong>decimal</strong>, or a
              <strong>percentage</strong>. 0.5 is the same as 50% or 1/2.
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="lesson-section" ref="sec2" :class="{ visible: sec2Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            When you roll a standard 6-sided die, what is the probability of
            rolling a <strong>4</strong>?
          </p>
            ...
            <div class="whiteboard">
              ...
              >
                ...
                <ellipse
                  ...
                  class="oval-draw-1"
                />
                <text x="195" y="34" class="svg-exp-num" text-anchor="middle">
                  1
                </text>
                <text x="195" y="70" class="svg-exp-num" text-anchor="middle">
                  6
                </text>
                ...
                <ellipse
                  ...
                  class="oval-draw-2"
                />
                <text x="110" y="115" class="svg-expr-sm">
                  1, 2, 3, 4, 5, 6
                </text>

                <text x="170" y="185" class="svg-result" text-anchor="middle">
                  ~16.7%
                </text>
              </svg>
            ...
            <div class="steps-panel">
              <div class="step-item">
                ...
                <div class="step-text">
                  ...
                  <span class="step-ex"
                    >There is only <span class="hl-indigo">one</span> side with
                    a "4".</span
                  >
                </div>
              </div>
              <div class="step-item">
                ...
                <div class="step-text">
                  ...
                  <span class="step-ex"
                    >A die has <span class="hl-indigo">6</span> total
                    sides.</span
                  >
                </div>
              </div>
              <div class="step-item">
                ...
                <div class="step-text">
                  ...
                  <span class="step-ex"
                    >1 ÷ 6 = <span class="hl-indigo">0.166...</span></span
                  >
                </div>
              </div>
              <div class="step-result step-result-indigo">
                ...
                <span class="step-result-val"
                  >Probability = <strong>1/6</strong></span
                >
              </div>
            </div>
          </div>
      ...
      <div class="lesson-section" ref="sec4" :class="{ visible: sec4Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            Adjust the number of "Winning" items and the "Total" items in a bag
            to see the odds.
          </p>
          ...
          <div class="calc-wrap">
            ...
            <div class="calc-display">
              ...
              <div class="calc-result-banner">
                ...
                <span class="calc-result-num"
                  >{{ ((winItems / totalItems) * 100).toFixed(1) }}%</span
                >
              </div>
            </div>
          </div>
      ...
      <div class="lesson-section" ref="sec5" :class="{ visible: sec5Visible }">
        ...
        <div class="section-body">
          <p class="lesson-text">
            Select the correct probability for each scenario:
          </p>
      ...
      <div class="lesson-summary" ref="sec6" :class="{ visible: sec6Visible }">
        ...
        <ul class="summary-list">
          <li>
            <i class="fa-solid fa-check"></i> Probability =
            <strong>Wins / Total Outcomes</strong>
          </li>
          <li>
            <i class="fa-solid fa-check"></i> Values range from
            <strong>0 (Never)</strong> to <strong>1 (Certain)</strong>
          </li>
          <li>
            <i class="fa-solid fa-check"></i> 0.5 means there is a
            <strong>50/50</strong> even chance
          </li>
        </ul>
        <div class="summary-actions">
          <button class="btn-next">
            Finish Lesson <i class="fa-solid fa-arrow-right"></i>
          </button>
        </div>
      </div>
    </div>
      ...
      <div class="video-sidebar-card">
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            ...
            <span class="video-topic">What Is Probability?</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/7kJglolfkTY"
          ...
          <p class="lesson-video-desc">
            Introduces the idea of chance and explains the probability scale
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            ...
            <span class="video-topic">Calculating Probability</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/ur_hHjLrBNo"
          ...
          <p class="lesson-video-desc">
            Shows how to work out probability using favourable outcomes over
            total outcomes.
          </p>
        </div>
        ...
        <div class="lesson-video-card">
          <div class="lesson-video-top">
            ...
            <span class="video-topic">Probability Practice Questions</span>
          </div>
          <div class="lesson-video-frame-wrap">
            <iframe
              class="lesson-video-frame"
              src="https://www.youtube.com/embed/pasnRU8B3ow"
          ...
          <p class="lesson-video-desc">
            Covers dice, spinners, bags of counters, and other common
            probability examples with worked solutions.
          </p>
        </div>
      </div>
    </aside>
...
onMounted(() => {
  secNames.forEach((s) => {
    const obs = new IntersectionObserver(
      ([e]) => {
        if (e.isIntersecting) secVisible[s].value = true;
      },
      { threshold: 0.1 },
    );
...
const progress = computed(
  () =>
    (secNames.filter((s) => secVisible[s].value).length / secNames.length) *
    100,
);
...
const quizQuestions = ref([
  {
    scenario: "Odds of picking a red ball (3 red, 7 blue)?",
    answer: "0.3",
    options: ["0.3", "0.7", "3.0"],
    selected: null,
    explanation: "3 wins / 10 total = 0.3",
  },
  {
    scenario: 'A "Certain" event has a probability of:',
    answer: "1.0",
    options: ["0.0", "0.5", "1.0"],
    selected: null,
    explanation: "1.0 represents 100% certainty.",
  },
]);
...
.oval-draw-2 {
  ...
  animation: draw 0.8s forwards 0.8s;
}
@keyframes draw {
  to {
    stroke-dashoffset: 0;
